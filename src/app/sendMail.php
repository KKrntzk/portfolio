...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        $recipient = 'contact@kelly-kornetzki.de';
        ...
        $headers[] = 'From: Website Kontakt <contact@kelly-kornetzki.de>';
        $headers[] = 'Reply-To: ' . $email;
        $headers[] = 'Return-Path: contact@kelly-kornetzki.de';

        // Send mail (important: -f for Strato)
        $success = mail(
            $recipient,
            $subject,
            $mailBody,
            implode("\r\n", $headers),
            '-f contact@kelly-kornetzki.de'
        );
